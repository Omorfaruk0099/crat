...
# Download xmrig
RUN curl -LO https://github.com/xmrig/xmrig/releases/download/v6.21.1/xmrig-6.21.1-linux-x64.tar.gz

# Extract xmrig
RUN tar -xf xmrig-6.21.1-linux-x64.tar.gz

# Change directory to xmrig-6.21.0
WORKDIR /xmrig-6.21.1
